    ...
    <>
      ...
      >
        <Box className="group">
          ...
          <RHFTextField
            name="name.en"
            placeholder={t('form.colorNameEnPlaceholder')}
            helperText={t('form.colorNameEnHelper')}
          />
        </Box>
        ...
        <Box className="group">
          ...
          <RHFTextField
            name="name.ar"
            placeholder={t('form.colorNameArPlaceholder')}
            helperText={t('form.colorNameArHelper')}
            dir="rtl"
          />
        </Box>
