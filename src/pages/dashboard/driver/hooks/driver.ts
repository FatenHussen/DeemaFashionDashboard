...
export const useFetchDrivers = (page: number = 1, limit: number = 25) => {
  return useQuery({
...
export const useFetchDriverById = (id: number | string) => {
  return useQuery({
...
export const useUpdateDriver = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.driver.list() });
      queryClient.invalidateQueries({ queryKey: queryKeys.driver.details });
    },
  });
};
