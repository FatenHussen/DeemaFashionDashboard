...
export default function Page() {
  ...
  const sidebarContent = (
    <div className="flex flex-col gap-5">
      <FilterGroup label={t('serviceProviderStatusFilterLabel')}>
  ...
  return (
    <>
      <title>{t('form.serviceProvidersIndexDocumentTitle', { appName: CONFIG.appName })}</title>
      <DataTable
        tableName={t('tableNames.serviceProviders')}
        ...
        hasDetails
        detailsLink="/service-providers/details"
        permissions={{
