  ...
  return (
    <>
      ...
      <DataTable
        ...
        isLoading={isLoading}
        columnTranslations={{ id: t('columns.id'), image: t('columns.image'), name: t('columns.name'), description: t('columns.description'), price: t('columns.price'), discount: t('form.recipeDiscountLabel'), rating: t('columns.rating'), orders_count: t('columns.orders'), created_at: t('columns.created'), actions: t('columns.action') }}
