...
export const NavItem = forwardRef<HTMLButtonElement, NavItemProps>(function NavItem({
  ...
  const rootItemClasses = mergeClasses([
    'w-full shrink-0 min-h-[var(--nav-item-root-height)]',
  ...
  const subItemClasses = mergeClasses([
    'w-full shrink-0 min-h-[var(--nav-item-sub-height)]',
  ...
  return (
    ...
    >
      ...
      {hasChild && (
        <Iconify
          icon={isSubItem ? 'eva:arrow-ios-forward-fill' : 'eva:arrow-ios-downward-fill'}
          className={mergeClasses([
