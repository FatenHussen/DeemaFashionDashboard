...
type SvgProps = React.SVGProps<SVGSVGElement> & { hideBackground?: boolean; className?: string };

function ForbiddenIllustration({ hideBackground, className, ...other }: SvgProps) {
  ...
  return (
    <svg
      ...
      className={mergeClasses([
        'w-80 max-w-full shrink-0 h-auto',
        className,
      ])}
      style={{
